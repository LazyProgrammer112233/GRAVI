...
// ============================================================
// COCO class ΓåÆ FMCG product type mapping
...
// ============================================================
// LAYER 1 ΓÇö YOLO via Roboflow Serverless Hosted API
...
async function runYOLODetection(
    ...
    try {
        ...
        if (!response.ok) {
            ...
            console.error(`[YOLO] Image ${imageIndex} HTTP error: ${response.status} ΓÇö ${errText}`);
...
// ============================================================
// LAYER 3 ΓÇö OCR via Qwen2.5-VL (OCR-specific prompt)
// Uses HF Inference API ΓÇö Qwen is excellent at reading text
// ============================================================
...
// ============================================================
// LAYER 2 ΓÇö Qwen 2.5-VL Vision-Language Reasoning
...
async function runQwenVLReasoning(
    ...
    // Build structured context JSON ΓÇö LLM receives THIS, not raw images
    ...
    const systemPrompt = `You are GRAVI Vision Intelligence v2 ΓÇö an elite FMCG retail analyst AI.
...
YOUR ABSOLUTE RULES ΓÇö NEVER VIOLATE:
1. You MUST NOT introduce any brand that is not: (a) detected by YOLO with confidenceΓëÑ0.50, OR (b) confirmed by OCR text, OR (c) clearly visible in image AND supported by both YOLO+OCR context.
...
5. If data is ambiguous ΓåÆ set confidence as "low" and state the reason.
...
Analyze the structured detection data provided. Then return:
{
  ...
  "brand_competition": "High fragmentation | Medium | Low ΓÇö based ONLY on detection count",
  "reasoning": "brief explanation based strictly on detection data",
  "ai_insights": [
    "factual insight 1 ΓÇö based only on detected data",
    "factual insight 2"
  ]
}`;
...
serve(async (req: Request) => {
    ...
    try {
        ...
        // ΓöÇΓöÇ STEP 1: URL Resolution ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
        ...
        // ΓöÇΓöÇ STEP 2: Place Lookup ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
        ...
        // ΓöÇΓöÇ STEP 3: Place Details ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
        ...
        // ΓöÇΓöÇ STEP 4: Identity Lock ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
        ...
        // ΓöÇΓöÇ STEP 5: Photo Download (max 4) ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
        ...
        // ΓöÇΓöÇ STEP 6: 3-LAYER PIPELINE (per image: Layer 1 + Layer 3 in parallel) ΓöÇ
        // Then aggregate ΓåÆ Layer 2
        ...
        // ΓöÇΓöÇ STEP 7: Layer 2 ΓÇö Qwen-VL Reasoning ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
        ...
        // ΓöÇΓöÇ STEP 8: Post-processing & Brand Validation ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
        ...
        // ΓöÇΓöÇ STEP 9: Compute Scores ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
        ...
        if (identityLock.place_id !== placeId) {
            return failedResponse("Identity lock violation ΓÇö analysis aborted.", analysisSessionId);
        }

        // ΓöÇΓöÇ STEP 10: Build Final Response ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
        const finalResponse = {
            // Pipeline metadata
